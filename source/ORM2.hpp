    ...
    namespace tuple_helper
    {
        ...
        void move_tuple_impl(L &lhs, R &rhs)
        {
            ...
            internal::static_if<std::integral_constant<bool, N != I + 1>{}>([](auto &l, auto &r)
                                                                            { move_tuple_impl<N, I + 1>(l, r); })(lhs, rhs);
        }
    }
    ...
    namespace internal
    {
        ...
        void move_tuple(L &lhs, R &rhs)
        {
            ...
            static_if<bool_type{}>([](auto &l, auto &r)
                                   { tuple_helper::move_tuple_impl<N, 0>(l, r); })(lhs, rhs);
        }
...
namespace sqlite_orm
{
    ...
    namespace constraints
    {
        ...
        struct on_update_delete_t : on_update_delete_base
        {
            ...
            on_update_delete_t(decltype(fk) fk_, decltype(update) update_, foreign_key_action action_) : on_update_delete_base{update_}, fk(fk_), _action(action_) {}
        ...
        struct foreign_key_t<std::tuple<Cs...>, std::tuple<Rs...>>
        {
            ...
            foreign_key_t(const self &other) : columns(other.columns), references(other.references), on_update(*this, true, other.on_update._action),
    ...
    namespace internal
    {
        ...
        struct column_t : column_base
        {
            ...
            column_t(std::string name_,
                     ...
                     getter_type getter_,
                     setter_type setter_,
                     constraints_type constraints_) : column_base{std::move(name_)},
...
namespace sqlite_orm
{
    ...
    namespace internal
    {
        ...
        struct dynamic_order_by_entry_t : order_by_base
        {
            ...
            dynamic_order_by_entry_t(decltype(name) name_, int asc_desc_, std::string collate_argument_) : order_by_base{asc_desc_, move(collate_argument_)}, name(move(name_)) {}
        };
        ...
        struct like_t : condition_t, like_string, internal::negatable_t
        {
            ...
            like_t(arg_t arg_, pattern_t pattern_, sqlite_orm::internal::optional_container<escape_t> escape_) : arg(std::move(arg_)), pattern(std::move(pattern_)), arg3(std::move(escape_)) {}
...
namespace sqlite_orm
{
    ...
    namespace internal
    {
        ...
        struct union_t : public compound_operator<L, R>, union_base
        {
            ...
            union_t(left_type l, right_type r, decltype(all) all_) : compound_operator<L, R>(std::move(l), std::move(r)), union_base{all_} {}
...
namespace sqlite_orm
{
    ...
    namespace internal
    {
        ...
        struct index_t : index_base
        {
            ...
            index_t(std::string name_, bool unique_, columns_type columns_) : index_base{move(name_), unique_}, columns(move(columns_)) {}
        ...
        struct storage_impl<H, Ts...> : public storage_impl<Ts...>
        {
            ...
            sync_schema_result schema_status(sqlite3 *db, bool preserve) const
            {
                ...
                if (!gottaCreateTable)
                {
                    ...
                    if (!gottaCreateTable)
                    { //  if all storage columns are equal to actual db columns but there are
...
namespace sqlite_orm
{
    ...
    namespace internal
    {
        ...
        struct object_from_column_builder : object_from_column_builder_base
        {
            ...
            object_from_column_builder(object_type &object_, sqlite3_stmt *stmt_) : object_from_column_builder_base{stmt_}, object(object_) {}
...
namespace sqlite_orm
{
    ...
    namespace internal
    {
        ...
        struct prepared_statement_t : prepared_statement_base
        {
            ...
            prepared_statement_t(T t_, sqlite3_stmt *stmt_, connection_ref con_) : prepared_statement_base{stmt_, std::move(con_)}, t(std::move(t_)) {}
        };
...
namespace sqlite_orm
{
    ...
    namespace internal
    {
        ...
        struct view_t
        {
            ...
            view_t(storage_type &stor, decltype(connection) conn, Args &&...args_) : storage(stor), connection(std::move(conn)), args{std::make_tuple(std::forward<Args>(args_)...)} {}
    ...
    namespace internal
    {
        ...
        struct transaction_guard_t
        {
            ...
            transaction_guard_t(connection_ref connection_,
                                ...
                                std::function<void()> rollback_func_) : connection(std::move(connection_)),
    ...
    namespace internal
    {
        ...
        struct backup_t
        {
            backup_t(connection_ref to_,
                     ...
                     std::unique_ptr<connection_holder> holder_) : handle(sqlite3_backup_init(to_.get(), zDestName.c_str(), from_.get(), zSourceName.c_str())),
            ...
            backup_t(backup_t &&other) : handle(other.handle), to(other.to), from(other.from), holder(move(other.holder))
            {
...
namespace sqlite_orm
{
    ...
    namespace internal
    {
        ...
        protected:
            storage_base(const std::string &filename_, int foreignKeysCount) : pragma(std::bind(&storage_base::get_connection, this)),
            ...
            storage_base(const storage_base &other) : on_open(other.on_open), pragma(std::bind(&storage_base::get_connection, this)),
...
namespace sqlite_orm
{
    ...
    namespace internal
    {
        ...
        struct storage_t : storage_base
        {
             ...
             */
            storage_t(const std::string &filename, impl_type impl_) : storage_base{filename, foreign_keys_count(impl_)}, impl(std::move(impl_)) {}
        ...
        public:
            ...
            dump_okidoki(const O &o)
            {
                std::vector<std::pair<std::string, std::string>> res;
                std::pair<std::string, std::string> aux_pivot;
                ...
                {
                    auto &p = pairs[i];
                    aux_pivot.first = p.first;
                    aux_pivot.second = p.second;
                    res.push_back(aux_pivot);
